...
namespace s3d
{
	...
	namespace Math
	{
		...
		Optional<Array<double>> SolveLinearEquation(const double a, const double b)
		{
			if (IsZero(a))
			{
				return none;
		...
		Optional<Array<double>> SolveQuadraticEquation(const double a, const double b, const double c)
		{
			if (IsZero(a))
			{
		...
		Optional<Array<double>> SolveCubicEquation(const double p, const double q)
		{
			Array<double> result;
		...
		Optional<Array<double>> SolveCubicEquation(const double a, const double b, const double c)
		{
		...
		Optional<Array<double>> SolveCubicEquation(const double a, const double b, const double c, const double d)
		{
			if (IsZero(a))
			{
