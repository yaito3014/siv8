...
# define SIV3D_COMPILER_PRIVATE_DEFINITION_APPLE_CLANG()	0
...
# elif (defined(__clang__) && defined(__apple_build_version__)) // Apple Clang
	...
	# undef	 SIV3D_COMPILER_PRIVATE_DEFINITION_APPLE_CLANG
	# define SIV3D_COMPILER_PRIVATE_DEFINITION_APPLE_CLANG()	1
...
# if (SIV3D_COMPILER(APPLE_CLANG) || SIV3D_COMPILER(CLANG) || SIV3D_COMPILER(GCC)) // Clang, GCC
...
# elif (SIV3D_COMPILER(APPLE_CLANG) || SIV3D_COMPILER(CLANG))
